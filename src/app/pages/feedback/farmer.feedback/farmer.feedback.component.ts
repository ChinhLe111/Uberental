...
@Component({
  selector: 'app-farmer.feedback',
  templateUrl: './farmer.feedback.component.html',
  providers: [OrdersFacade, GlobalFacade],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FarmerFeedbackComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    ...
    this.OrdersFacade.getFeedBackFarmer(this.route.snapshot.params.id);
